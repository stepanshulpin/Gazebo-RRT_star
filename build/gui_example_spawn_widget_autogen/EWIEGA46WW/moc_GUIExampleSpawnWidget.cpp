...
struct qt_meta_stringdata_gazebo__GUIExampleSpawnWidget_t {
    QByteArrayData data[1];
    char stringdata0[30];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_gazebo__GUIExampleSpawnWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_gazebo__GUIExampleSpawnWidget_t qt_meta_stringdata_gazebo__GUIExampleSpawnWidget = {
    {
QT_MOC_LITERAL(0, 0, 29) // "gazebo::GUIExampleSpawnWidget"

    },
    "gazebo::GUIExampleSpawnWidget"
};
...
const QMetaObject gazebo::GUIExampleSpawnWidget::staticMetaObject = {
    { &GUIPlugin::staticMetaObject, qt_meta_stringdata_gazebo__GUIExampleSpawnWidget.data,
      qt_meta_data_gazebo__GUIExampleSpawnWidget,  qt_static_metacall, nullptr, nullptr}
};
...
void *gazebo::GUIExampleSpawnWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gazebo__GUIExampleSpawnWidget.stringdata0))
